...
class XArmHardwareNode(Node):
    def __init__(self):
        ...
        [250, 600, 359, 828, 242, 589], # cell 1
        [250, 459, 359, 852, 258, 469], # cell 2
        [250, 347, 360, 839, 250, 358], # cell 3
        [250, 569, 296, 688, 178, 585], # cell 4
        [250, 469, 296, 703, 187, 489], # cell 5
        [250, 379, 260, 598, 134, 394], # cell 6
        [250, 570, 408, 661, 135, 582], # cell 7
        [250, 522, 345, 619, 135, 504], # cell 8
        [250, 432, 433, 672, 135, 429], # cell 9
        ]
    ...
    def MoveGraspedToDeposit_callback(self, request, response):
        ...
        drop_target = [700, 469, 296, 500, 187, 489] # straight in front
...
gripper_open_count   = 250

POSITIONS = {
    0: [250, 500, 500, 500, 500, 500],
    1: [250, 600, 359, 828, 242, 589],
    2: [250, 459, 359, 852, 258, 469],
    3: [250, 347, 360, 839, 250, 358],
    4: [250, 569, 296, 688, 178, 585],
    5: [250, 469, 296, 703, 187, 489],
    6: [250, 379, 260, 598, 134, 394],
    7: [250, 570, 408, 661, 135, 582],
    8: [250, 522, 345, 619, 135, 504],
    9: [250, 432, 433, 672, 135, 429],
}

POSITION_DROP = [700, 457, 151, 577, 213, 99] off to the left
POSITION_DROP = [332, 498, 767, 170, 565, 507] straight in front
'''
